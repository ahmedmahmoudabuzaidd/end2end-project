...
This project demonstrates a complete **DevOps CI/CD pipeline** from code to deployment, monitoring, and end-user delivery.
...
7. **Monitoring** is done with **Prometheus** and **Grafana**.
8. Notifications sent via **Gmail** to stakeholders.
